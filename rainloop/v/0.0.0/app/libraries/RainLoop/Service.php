...
class Service
{
	...
	private function indexTemplateParameters($bAdmin = false, $bMobile = false, $bMobileDevice = false)
	{
		...
		$aTemplateParameters = array(
			...
			'{{UinverCssLink}}' => $this->staticPath('css/univer.css'),
			'{{UinverCollaborationClientCssLink}}' => $this->staticPath('css/collaboration-client.css'),
			'{{UinverSheetsPivotUiCssLink}}' => $this->staticPath('css/sheets-pivot-ui.css'),
			...
			'{{UinverFullJsLink}}' => $this->staticPath('js/univer.full.umd.js'),
			'{{UinverEnUSJsLink}}' => $this->staticPath('js/en-US.js'),
			...
			'{{UinverPivotEngineJsLink}}' => $this->staticPath('js/pivot-engine.js'),
			'{{UinverSheetsPivotJsLink}}' => $this->staticPath('js/sheets-pivot.js'),
			'{{UinverSheetsPivotUiJsLink}}' => $this->staticPath('js/sheets-pivot-ui.js'),
